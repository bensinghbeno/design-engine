 ...
 * Command line was: qdbusxml2cpp -v -c clientIf -p clientIf.h:clientIf.cpp com.dbus.example.interface.xml
 *
...
public:
  ...
  ~SignalReceiver(){}
public slots:
  void receivedSignal(QString aStr)
  {
    qDebug()<<"ben client receivedSignal = "<<aStr;
  }
};

...
* Used org.genivi.commonapi.someip 3.1.12.v202004121738.
...
public:
            ...
            std::dynamic_pointer_cast< HelloWorldStub>(_stub))
    {
                ...
                HelloWorldSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x80e8) }, &sayHelloStubDispatcher );
